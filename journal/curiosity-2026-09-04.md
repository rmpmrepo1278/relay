...
🌱 **Adjacent to self hosting:** k3s
  ...
  • K3s on Ubuntu 24.04: Lightweight Kubernetes Guide 2026 | Kubernetes | Dev Corner
    https://vucense.com/dev-corner/k3s-kubernetes-install-ubuntu-2026/
...
📄 **arXiv (ai agents):**
  • Compile by Training: Turning Natural-Language Specifications into Local Neural F
    http://arxiv.org/abs/2609.04199v1
  • Clean Engineering, Unstable Measurement: A Preregistered Reliability Failure of 
