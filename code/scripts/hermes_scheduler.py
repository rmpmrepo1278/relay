...
Job("homelab_reporter", p(f"{h}/scripts/homelab_reporter.py"),
        ...
        Job("cve_scan", s(f"{h}/scripts/cve_scan.sh"),
            Schedule(minute="30", hour="4", day_of_week="0"), timeout=3600, description="Weekly trivy scan of key images", tags=["security"],
...
# DISABLED         # Note: telegram_bot runs in screen session, not scheduled (daemon)
        ...
        Job("action_tuning", f"python3 /home/rohit/.hermes/scripts/action_loop.py tune",
            Schedule(minute="30", hour="8", day_of_week="0"), timeout=60, description="PA Tier-3 weekly action-loop learning ledger tuning brief", tags=["pa", "learning"], circuit="telegram_bridge"),
